  ...
  return (
    <div className='container mx-auto'>
      <div className='relative w-full flex justify-center flex-col items-center '>
        ...
        <div className='lg:w-[70%] flex flex-col  text-white gap-y-10 z-10'>
          <h1 className='text-9xl font-bold '>CUSTOM</h1>
          <h1 className='text-9xl font-bold text-end '>TECHNOLOGY</h1>
        </div>
